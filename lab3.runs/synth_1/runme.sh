...
HD_PWD='C:/Users/joelb/dev-vhdl/524/hw0/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ssblend.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ssblend.tcl
