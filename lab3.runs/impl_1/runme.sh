...
HD_PWD='C:/Users/joelb/dev-vhdl/524/hw0/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ssblend.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ssblend.tcl -notrace
